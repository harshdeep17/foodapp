  ...
  return (
    <>
      <div className="bg-yellow-500">
        <div className="flex justify-between items-center px-6 py-4 sm:px-12">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 mt-8 sm:py-4">
          <div className="sm:my-auto">
            ...
            <h1 className="text-center text-white font-serif text-3xl">Delicious Burger</h1>
            <p className="text-lg py-8  px-4 text-center text-white">
